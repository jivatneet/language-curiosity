...
def main():
    ...
    is_render = True
    model_path = 'curiosity-driven-exploration-pytorch/models/{}.model'.format(env_id)
    predictor_path = 'curiosity-driven-exploration-pytorch/models/{}.pred'.format(env_id)
    target_path = 'curiosity-driven-exploration-pytorch/models/{}.target'.format(env_id)
