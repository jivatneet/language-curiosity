...
def main(args):
    ...
    is_load_model = False
    is_render = False
    model_path = 'models/qa-icm-moreques-singleques-sparsegoal2/{}.model'.format(env_id)
    icm_path = 'models/qa-icm-moreques-singleques-sparsegoal2/{}.icm'.format(env_id)
    ...
    '''
    num_questions = 1 # set according to number of ques you want to sample
